...
<body>
    <main>
        <h1>THÊM BÓNG RỔ</h1>
        <form action="admin.php?page_layout=thembongro" method="post" enctype="multipart/form-data">
            ...
            <div>
                <p>Ứng dụng</p>
                <textarea name="ung_dung" rows="5" style="width:100%"></textarea>
            </div>
            <div>
                <p>Tiêu đề</p>
        ...
        if (
            ...
            if ($uploadOk == 0) {
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    ...
                    $sql = "INSERT INTO `bong_ro`(`ma_sp`, `thuong_hieu_id`, `loai_sp_id`, `color`, `size_id`, `price`, `chat_lieu`, `pic`, `ung_dung`, `title_id`,`infor`)
                        VALUES 
                        ('$maSp', '$thuongHieuId', '$loaiSpId', '$color', '$sizeId', '$price', '$chatLieu', '$target_file', '$ungDung', '$title','$infor')";
                    ...
                    echo '<script>window.location.href = "admin.php?page_layout=quanlybongro";</script>';
