...
<body>
    ...
    <main>
       ...
       <h1>Sửa sản phẩm</h1>
        <form action="admin.php?page_layout=suabongro&id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
            ...
            <br>
            <div>
                <input type="submit" name="btn_submit" value="Sửa Sản Phẩm">
            </div>
        </form>
        ...
        if (
            ...
            if($uploadOk == 0){
                ...
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                    ...
                    // Câu lệnh INSERT cho bảng 
                   $sql = "UPDATE `bong_ro` SET 
                            `ma_sp`='$maSp',
