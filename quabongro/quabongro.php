...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/quabongro/bongro.css">
</head>
                ...
                while ($bong_ro = mysqli_fetch_array($result)) {
                    ...
                    <div class="content">
                        <div class="content-image">
                            ...
                            <a href="trangchu.php?page_layout=chitietsp&id=<?php echo $bong_ro['id']; ?>&loai=bong">
