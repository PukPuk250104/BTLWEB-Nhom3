...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/quanao/code/quanao.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / Quần áo bóng rổ
            </div>
            <div class="arrange">
                ...
                <div class="right-bot-content">
                    ...
                    <div class="content">
                        ...
                        <div class="content-infor">
                            <div class="infor">
                                <span style="color: gray; font-size: small; text-decoration"><?php echo $quan_ao['title']?></span>
