...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/quanaonba/codeS/quanaonba.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">Trang chủ</a> / <a href="trangchu.php?page_layout=quanaobongro">Quần áo bóng rổ</a> / <b>Bộ quần áo thi đấu NBA</b>
            </div>
            <div class="arrange">
    ...
    <script src="/BTLWEB/quanaonba/codeS/quanaonba.js"></script>
</body>
</html> 