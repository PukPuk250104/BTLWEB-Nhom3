...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/phukienbongro/trang1/phukien1.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / <b>  Phụ kiện bóng rổ</b>
            </div>
            <div class="arrange">
                ...
                <div class="right-bot-content">
                    <div class="content">
                        <div class="content-image">
                            <a href="#"><img src="/BTLWEB/phukienbongro/trang1/images/con1.webp" alt="NBA"></a>
                        </div>
                        <div class="content-infor">
                            <div class="infor">
                                <span style="color: gray; font-size: small;">BALO BÓNG RỔ</span>
                                <br><span><a href="#" class="type">Balo Bóng Rổ Nike Air Hoop Elite ‘Elemental Pink’ – Hồng | Replica</a></span>
                            </div>
                            </div>
                        <div class="price-tag">
                                <span class="price"><b>130,000VND</b></span>
                        </div>  
    ...
    <script src="/BTLWEB/phukienbongro/trang1/phukien1.js"></script>
</body>
</html> 