...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/procombat/code/procombat.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / <a href="trangchu.php?page_layout=quanaobongro">Quần áo bóng rổ</a> / <b>Pro combat</b>
            </div>
            <div class="arrange">
                ...
                <div class="right-bot-content">
                    <div class="content">
                        <div class="content-image">
                            <img id="iconImg" src="/BTLWEB/procombat/images/con-1.png" alt="NBA">
                        </div>
                        <div class="content-infor">
                            <span style="color: gray; font-size: small;">Pro combat</span>
                            <br><span><a href="#" class="type">Quần bóng rổ Pro Combat 3/4 đệm gối #1055</a></span>
                        </div>
                        <div class="price-tag">
                            <span class="price"><b>79,000 VND</b></span>
                        </div>
                        <div class="content-colorway">
                            <div class="icon-pic" onclick="chooseIcon(1,this)">
                                <img src="/BTLWEB/procombat/images/con-1.png"alt="pic">
                            </div>
                            <div class="icon-pic" onclick="chooseIcon(2,this)">
                                <img src="/BTLWEB/procombat/images/pic-2con-1.png"alt="pic">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/BTLWEB/procombat/code/procombat.js"></script>
</body>
</html> 