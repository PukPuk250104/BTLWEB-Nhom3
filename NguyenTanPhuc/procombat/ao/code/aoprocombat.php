...
<head>
    ...
    <title>Áo combat</title>
    <link rel="stylesheet" href="/BTLWEB/procombat/ao/code/aoprocombat.css">
</head>
<body>

        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / <a href="trangchu.php?page_layout=procombat">Pro combat</a> / <b>Kết quả tìm kiếm "áo combat"</b>
            </div>
            <div class="arrange">
                <span>Hiển thị 4 kết quả  </span>  
                ...
                <div class="right-bot-content">
                    <div class="content">
                        <div class="content-image">
                            <a href="#"><img id="iconImg" src="/BTLWEB/procombat/ao/images/con-5.png" alt="NBA"></a>
                        </div>
                        <div class="content-infor">
                            <span style="color: gray; font-size: small;">Pro combat</span>
                            <br><span><a href="#" class="type">Áo bóng rổ Pro Combat ba lỗ quai nhỏ #1001</a></span>
                        </div>
                        <div class="price-tag">
                            <span class="price"><b>100,000 VND</b></span>
                        </div>
                        <div class="content-colorway">
                            <div class="icon-pic" onclick="chooseIcon(1, this)">
                                <a href="#"><img  src="/BTLWEB/procombat/ao/images/con-5.png"alt="pic"></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/BTLWEB/procombat/ao/code/aoprocombat.js"></script>
</body>
</html> 