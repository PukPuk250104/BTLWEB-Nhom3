...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/procombat/quan/code/quanprocombat.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">Trang chủ</a> / <a href="trangchu.php?page_layout=procombat">Pro combat</a> / <b>Kết quả tìm kiếm "quần combat"</b>
            </div>
            <div class="arrange">
                ...
                <div class="right-bot-content">
                    <div class="content">
                        <div class="content-image">
                            <a href="#"><img id="iconImg" src="/BTLWEB/procombat/quan/images/con-1.png" alt="NBA"></a>
                        </div>
                        ...
                        <div class="price-tag">
                            <span class="price"><b>110,000 VND</b></span>
                        </div>
                        <div class="content-colorway">
                            <div class="icon-pic" onclick="chooseIcon(1,this)">
                                <img src="/BTLWEB/procombat/quan/images/con-1.png"alt="pic">
                            </div>
                        </div>
                    </div>
    ...
    <script src="/BTLWEB/procombat/quan/code/quanprocombat.js"></script>
</body>
</html> 