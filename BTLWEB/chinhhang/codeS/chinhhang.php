...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/chinhhang/codeS/chinhhang.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / <a href="trangchu.php?page_layout=phukienbongro">  phụ kiện bóng rổ</a> /<a href="trangchu.php?page_layout=chinhhang">  ba lô bóng rổ</a> 
    ...
    ?>
                         ...
                         <div class="content">
                            ...
                            <div class="icon-pic" onclick="chooseIcon(1,this)">
                                <img src="/BTLWEB/chinhhang/images/pic-1-con-1.webp"alt="pic">
                            </div>
                            <div class="icon-pic" onclick="chooseIcon(2,this)">
                                <img src="/BTLWEB/chinhhang/images/pic-1-con-2.webp" alt="pic">
                            </div>
                 ...
                 <?php
                    ...
                    <div class="content">
                        <div class="content-image">
                            <a href="#"><img src="/BTLWEB/chinhhang/codeS/anh3/53.webp" alt="NBA"></a>
                        </div>
                        <div class="content-infor">
    ...
    <script src="/BTLWEB/chinhhang/codeS/chinhhang.js"></script>
</body>
</html> 