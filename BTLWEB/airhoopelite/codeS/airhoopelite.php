...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/airhoopelite/codeS/airhoopelite.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / <a href="trangchu.php?page_layout=cuahang">  Cửa hàng</a> /<a href="trangchu.php?page_layout=airhoopelite">  kết quả tìm kiếm "airhoopelite"</a> 
            </div>
            <div class="arrange">
    ...
    ?>
                         ...
                         <div class="content">
                            ...
                            <div class="icon-pic" onclick="chooseIcon(1,this)">
                                <img src="/BTLWEB/airhoopelite/images/pic-1-con-1.webp"alt="pic">
                            </div>
                            <div class="icon-pic" onclick="chooseIcon(2,this)">
                                <img src="/BTLWEB/airhoopelite/images/pic-1-con-2.webp" alt="pic">
                            </div>
                            <div class="icon-pic" onclick="chooseIcon(3,this)">
                                <img src="/BTLWEB/airhoopelite//images/pic-1-con-3.webp" alt="pic">
                            </div>
                        </div>
                        </div>
                         </div>
                     ...
                     <div class="content">
                        ...
                        <div class="content-image">
                            ...
                            <a href="#">
                                ...
                                <img src="/BTLWEB/airhoopelite/codeS/ảnh1/1.webp" alt="NBA"></a>

                        </div>
                        <div class="content-infor">
                            <span style="color: gray; font-size: small;">BA LÔ BÓNG RỔ</span>
                            <br><span><a href="#" class="type">Balo Bóng Rổ Nike Air Hoop Elite ‘Elemental Pink’ – Hồng
                                    | Replica
                                </a></span>
                            <br>
                            <br>
    ...
    <script src="/BTLWEB/airhoopelite/codeS/airhoopelite.js"></script>
</body>
</html> 