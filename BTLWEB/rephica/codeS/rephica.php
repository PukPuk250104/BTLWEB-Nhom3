 ...
 <head>
     ...
     <link rel="stylesheet" href="/BTLWEB/rephica/codeS/rephica.css">
 </head>

 <body>
     <div class="top-main">
         <div class="danhmuc">
             <a href="trangchu.php?page_layout=trangchu"> Trang chủ</a> / <a href="trangchu.php?page_layout=phukienbongro"> phụ kiện bóng rổ</a> /<a href="trangchu.php?page_layout=rephica"> ba lô bóng rổ</a>
    ...
    ?>
                         ...
                         <div class="content">
                             ...
                             <div class="content-infor">
                                 ...
                                 <div class="content-colorway">
                                     <div class="icon-pic">
                                         <img src="/BTLWEB/rephica/images/pic-2-con-1.webp" alt="pic">
                                     </div>
                                     <div class="icon-pic" onclick="chooseIcon(5,this)">
                                         <img src="/BTLWEB/rephica/images/pic-2-con-2.webp" alt="pic">
                                     </div>
                                     <div class="icon-pic" onclick="chooseIcon(6,this)">
                                         <img src="/BTLWEB/rephica/images/pic-2-con-3.webp" alt="pic">
                                     </div>
                                 </div>
                             </div>
                         </div>
             ...
             <div class="content">
                 <div class="content-image">
                     <a href="#"><img src="/BTLWEB/rephica/codeS/anh3/2.webp" alt="NBA"></a>
                 </div>
                 <div class="content-infor">
    ...
    ?> -->
     ...
     <script src="/BTLWEB/rephica/codeS/rephica.js"></script>
 </body>
