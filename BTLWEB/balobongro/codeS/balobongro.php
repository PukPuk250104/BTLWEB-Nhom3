...
<head>
    ...
    <link rel="stylesheet" href="/BTLWEB/balobongro/codeS/balobongro.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=trangchu">  Trang chủ</a> / <a href="trangchu.php?page_layout=phukienbongro">  phụ kiện bóng rổ</a> /<a href="trangchu.php?page_layout=balobongro">  ba lô bóng rổ</a> /
            </div>
            <div class="arrange">
    ...
    ?>
                         ...
                         <div class="content">
                            ...
                            <div class="icon-pic" onclick="chooseIcon(4,this)">
                                <img src="/BTLWEB/balobongro/images/pic-2-con-1.webp"alt="pic">
                            </div>
                            <div class="icon-pic" onclick="chooseIcon(5,this)">
                                <img src="/BTLWEB/balobongro/images/pic-2-con-2.webp" alt="pic">
                            </div>
                            <div class="icon-pic" onclick="chooseIcon(6,this)">
                                <img src="/BTLWEB/balobongro/images/pic-2-con-3.webp" alt="pic">
                            </div>
                 ...
                 <?php
                    ...
                    ?>
                      ...
                      <div class="content">
                        <div class="content-image">
                            <a href="#"><img src="/BTLWEB/balobongro/codeS/anh3/2.webp" alt="NBA"></a>
                        </div>
                        <div class="content-infor">
                            <span style="color: gray; font-size: small;">BA LÔ BÓNG RỔ</span>
                            <br><span><a href="#" class="type">Balo Nike Varsity Elite V3 – Replica
    ...
    <script src="/BTLWEB/balobongro/codeS/balobongro.js"></script>
</body>
</html> 