...
<head>
    ...
    <title>Giày bóng rổ</title>
    <link rel="stylesheet" href="/BTLWEB/giaybongro/code/giaybongro.css">
</head>
<body>
        <div class="top-main">
            <div class="danhmuc">
                <a href="trangchu.php?page_layout=giaybongro">  Trang chủ</a> /   Giày bóng rổ 
            </div>
            <div class="arrange">
        ...
        <div class="bot-main">
            ...
            <div class="right-bot-main">
                <div class="right-bot-content">
                    <?php
                $sql = "SELECT g.*, t.title 
                                FROM `giay` g
                                JOIN `title` t 
                                ON g.title_id = t.id 
                                ORDER BY id DESC";
                $result = mysqli_query($conn, $sql);
                while ($giay = mysqli_fetch_array($result)) {
                    ?>
                    <div class="content">
                        <div class="content-image">
                            ...
                            <a href="trangchu.php?page_layout=chitietsp&id=<?php echo $giay['id']; ?>&loai=giay">
                                <img id="iconImg" src="<?php echo $finalSrc; ?>" alt="NBA"
                                    style="width: 100%; height: auto;">
                            </a>
                        </div>
                        <div class="content-infor">
                            <span style="color: gray; font-size: small;"><?php echo $giay['title'] ?></span>
                            <br><span><a href="#" class="type"><?php echo $giay['infor'] ?></a></span>
                        </div>
                        <div class="price-tag">
                            <span class="price"><b><?php echo $giay['price'] . " " . "VND" ?></b></span>
                        </div>
